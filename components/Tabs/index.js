...
const Tabs = ({ categories, handleOnSearch }) => {
    ...
    return (
        <div className="my-0 flex items-center flex-wrap sm:flex-nowrap justify-between border-b-2 border-gray-100">
            ...
            <div className="flex items-center sm:mt-0 mt-1.5">
                <svg
